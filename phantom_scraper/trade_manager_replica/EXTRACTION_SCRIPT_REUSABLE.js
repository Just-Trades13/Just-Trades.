// ============================================
// REUSABLE TRADE MANAGER EXTRACTION SCRIPT
// Can be run multiple times - won't create duplicates
// ============================================

// Clear existing if needed
if (window.extractTradeManager) {
    console.log('🔄 Reloading extraction script...');
}
...
// Create or update extraction data
const extractionData = window.extractionData || {
...
// Update timestamp and page info
extractionData.timestamp = new Date().toISOString();
extractionData.url = window.location.href;
extractionData.page = window.location.pathname;
...
function extractStyles() {
    ...
    console.log('✅ Styles extracted (' + count + ' elements)');
}
...
function extractMeasurements() {
    ...
    console.log('✅ Measurements extracted (' + count + ' elements)');
}
...
function extractElements() {
    ...
    console.log('✅ Extracted ' + buttonCount + ' buttons');
    ...
    console.log('✅ Extracted ' + cardCount + ' cards');
...
function monitorAPICalls() {
    ...
    if (window._apiMonitoringActive) {
    ...
    window._apiMonitoringActive = true;
...
// Make available globally (update if exists)
window.extractionData = extractionData;
